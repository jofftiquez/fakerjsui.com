<template>
  <p>
    ...
    disclose and make use of personal information. We are committed to
    conducting our business in accordance with these principles in order to
    ensure that the confidentiality of personal information is protected and
    maintained.
  </p>
  <p>
    Parmazip Inc. - Canada (to be incorporated) and Team O.P.S. Inc. -
    Philippines ("us", "we", or "our") operate the www.parmazip.com website and
    the Parmazip application (the "Service").
  </p>
  <p>
  ...
  <p>
    ...
    your email address, name, phone number, postal address, other information
  ...
  <p>
    ...
    our Service's functionality. These third-party service providers have their
  ...
  <p>
    ...
    location services when you use our Service at any time, through your mobile
    device settings.
  </p>
  <b>Cookies</b>
  <p>
  ...
  <b>DoubleClick Cookie</b>
  <p>
    Google, as a third-party vendor, uses cookies to serve ads on our Service.
    Google's use of the DoubleClick cookie enables it and its partners to serve
    ads to our users based on their visit to our Service or other web sites on
    the Internet.
  </p>
  <p>
  ...
  <p>
    If Parmazip is involved in a merger, acquisition or asset sale, your
  ...
  <p>
    If you are located outside the Philippines and choose to provide information
    to us, please note that we transfer the information, including Personal
    Information, to the Philippines and process it there.
  </p>
  <p>
    We may also use cloud-based tools like Stripe, Google Cloud, MongoDB in
    processing personal information. Their servers may be distributed globally.
  </p>
  <p>
  ...
  <p>
    ...
    and in other countries where laws regarding processing of Personal Data may
    be less stringent than the laws in your country. We constantly improve our
    service to comply with the US Health Insurance Portability and
    Accountability Act (HIPAA) and the Data Privacy Act (DPA) of the
    Philippines.
  </p>
